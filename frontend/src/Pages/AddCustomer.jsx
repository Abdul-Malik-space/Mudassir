...
const CustomerManager = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok) { fetchCustomers(); closeForm(); }
  ...
  const closeForm = () => {
    setFormData({
      customerName: '', phoneNumber: '', alternatePhone: '',
  ...
  if (!showForm) {
    return (
      // ✅ FIX 1: p-2 on mobile, p-6 on desktop
      <div className="w-full mx-auto p-2 sm:p-4 md:p-6 space-y-4">

        {/* HEADER — ✅ FIX 2: flex-wrap so buttons don't overflow */}
        ...
        {/* TABLE WRAPPER — ✅ FIX 3: proper overflow container */}
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          {/* ✅ FIX 4: -mx trick ensures table scroll works inside padded containers */}
            ...
            <table className="w-full text-left text-xs border-collapse" style={{ minWidth: '500px' }}>
              ...
              <thead className="bg-slate-50 text-slate-500 font-bold uppercase tracking-wider border-b border-slate-200">
                <tr>
                  ...
                  {/* ✅ FIX 5: hide less important columns on mobile */}
                ...
                {customers.map((customer) => (
                  <tr key={customer._id} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="px-3 sm:px-5 py-3 font-bold text-emerald-600 whitespace-nowrap">
                      Rs. {Number(customer.openingBalance || customer.balance || 0).toLocaleString()}
                    </td>
  ...
  return (
    // ✅ Same padding fix for form view
        ...
        <div className="p-4 sm:p-6 space-y-6 sm:space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-slate-600">Customer Status</label>
                <select
